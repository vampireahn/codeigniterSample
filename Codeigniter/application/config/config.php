...
if (php_sapi_name() != 'cli') {
	// 접속하는 주소에 따라 자동으로 설정되어 수정이 불필요함.
...
$config['cookie_path']		= '/';
$config['cookie_secure'] = (strtolower(env('COOKIE_SECURE')?:'false')==='true');
$config['cookie_httponly'] = (strtolower(env('COOKIE_HTTPONLY')?:'true')==='true');
...
$config['csrf_regenerate'] = TRUE; // 각 요청마다 토큰을 갱신할지 여부
// CSRF 보호에서 제외할 URI 목록입니다.
// API 엔드포인트나 웹훅(webhook)과 같이 외부 서비스와 연동되는 경로를 추가합니다.
$config['csrf_exclude_uris'] = array(
	'api/(.+)' // 'api/'로 시작하는 모든 경로 (정규식 사용)
);
